...
if(isset($_GET["dictionary"])) 
{
   ...
   { 
       ...
       if(isset($obj->{'COM_FIELDSATTACH_DEFAULT'})) $defaultvalue=  $obj->{'COM_FIELDSATTACH_DEFAULTVALUE'}; // 
...
ObjInput = new Class({
	...
	initialize: function(id, options) {
        ...
        revalue: function(){
            ...
            defaultvalue = el.getElement("input#jform_params_field_defaultvalue").get("value");
        ...
        { 
            ...
            $('jform_params_field_defaultvalue').set("value", defaultvalue); 
        },
